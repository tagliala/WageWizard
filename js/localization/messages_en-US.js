WageWizard.messages = {
  ...
  player1_low_stamina_se: WageWizard.format("There is a very little chance that Player 1, playing as a defender, could generate a bad stamina event at or after minute {0}."),
  player2_low_stamina_se: WageWizard.format("There is a very little chance that Player 2, playing as a defender, could generate a bad stamina event if he enters the field at or before minute {0}."),
  p1_low_stamina: " (P1 bad stamina &darr;) ",
  p2_low_stamina: " (P2 bad stamina &uarr;) ",
