...
(function() {
  "use strict";
  var BASE_SALARY, PR_ENUM_ROLE, SKILL_VALIDATION, VERSION, WEEKS, WageWizard, applySecondaryDiscounts, getKeeperComponents, getPlayerBonus, getRate, getSalaryComponents, getSetPiecesMultipliers, getWageMultiplier, setData, setKeeperSkill, setMinAndMaxSalary, setPlayerData, setPlayerSkills, setPrimarySkill, setSetPiecesSkill, validateSkill;
  ...
  getWageMultiplier = function(player) {
  ...
  setMinAndMaxSalary = function(player) {
    ...
    base_salary = player.Special ? 1.1 * BASE_SALARY : BASE_SALARY;
  ...
  setKeeperSkill = function(player) {
    var keeperComponents, wage_multiplier;
    player.WageWizard.Skills['KeeperSkill'] = {};
    wage_multiplier = getWageMultiplier(player);
    keeperComponents = getKeeperComponents(player.KeeperSkill);
    player.WageWizard.Skills['KeeperSkill'].min = keeperComponents[0] * player.WageWizard.rate * wage_multiplier;
    player.WageWizard.Skills['KeeperSkill'].max = keeperComponents[1] * player.WageWizard.rate * wage_multiplier;
  };
  ...
  setPlayerSkills = function(player) {
    var wage_multiplier, salaryComponents, skill;
    ...
    for (skill in WageWizard.FORMULAE) {
      ...
      player.WageWizard.Skills[skill].min = salaryComponents[0] * player.WageWizard.rate * wage_multiplier;
      player.WageWizard.Skills[skill].max = salaryComponents[1] * player.WageWizard.rate * wage_multiplier;
    }
  };
