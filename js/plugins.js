...
(function() {
  ...
  var ClippableBehavior, WageWizard;
  ...
  ClippableBehavior = (function() {
    ...
    ClippableBehavior.prototype.initializeBridge = function() {
      ...
      if (this.flashBridge.length === 0) {
        ...
        this.flashBridge.attr("data-original-title", WageWizard.messages.copy_to_clipboard);
        this.flashBridge.attr("data-copied-hint", WageWizard.messages.copied_to_clipboard);
        this.flashBridge.attr("data-copy-hint", WageWizard.messages.copy_to_clipboard);
        ...
        this.flashBridge.on("clippable:copied", function() {
          ...
          $element.tooltip("show");
          return WageWizard.ClippableBehavior.handleCopied();
        });
    ...
    ClippableBehavior.prototype.detectFlashSupport = function() {
      ...
      if (!flashSupported) {
        ...
        this.element.tooltip({
          "title": WageWizard.messages.no_flash,
          "placement": "bottom"
        });
      }
  ...
  WageWizard.ClippableBehavior.handleCopied = function() {
  ...
  $(function() {
    return $(this).find(".js-clippy").each(function() {
      return new WageWizard.ClippableBehavior(this);
    });
  });
