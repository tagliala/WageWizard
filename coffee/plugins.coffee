...
class ClippableBehavior
  ...
  initializeBridge: ->
    ...
    if @flashBridge.length is 0
      ...
      @flashBridge.css
        ...
        width: "14px"
        height: "14px"
      @flashBridge.attr "data-original-title", WageWizard.messages.copy_to_clipboard
      @flashBridge.attr "data-copied-hint", WageWizard.messages.copied_to_clipboard
      @flashBridge.attr "data-copy-hint", WageWizard.messages.copy_to_clipboard
      @flashBridge.tooltip
        trigger: "manual"
        placement: "bottom"
      ...
      @flashBridge.on("clippable:copied", ->
        ...
        $element.tooltip "show"
        WageWizard.ClippableBehavior.handleCopied()
      )
  ...
  detectFlashSupport: ->
    ...
    unless flashSupported
      ...
      @element.tooltip { "title":WageWizard.messages.no_flash, "placement" : "bottom" }
    flashSupported

WageWizard.ClippableBehavior = ClippableBehavior
WageWizard.ClippableBehavior.handleCopied = ->
...
$(->
  $(this).find(".js-clippy").each ->
    new WageWizard.ClippableBehavior(this)
)